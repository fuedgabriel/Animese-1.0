...
class API {
  ...
  static Future searchAnimeCategory(String name) async{
    String url = baseUrl + "/api/anime/category/";
    Map data = {
      'Category': '$name'
    };
...
class POST
{
  ...
  static Future<http.Response> postcreate (nome, nick, senha, email, nasc) async {
    var key = utf8.encode(senha);
    var hash = sha512.convert(key);
