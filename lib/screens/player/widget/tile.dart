...
class ContentScroll extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      shrinkWrap: true,
      itemCount: int.parse((images[images.length-1].season)),
      itemBuilder: (BuildContext context, int index) {
        return ExpansionTile(
          leading: Icon(Icons.movie),
          title: Text('Temporada '+movies.seasons.toString()),
          children: <Widget>[
            ListView.builder(
                shrinkWrap: true,
                              ...
                              children: <Widget>[
                                Opacity(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        'Episódio ' + images[0].episode.toString() +'   ',
                                        style: TextStyle(
                                            fontSize: 16,
                                ...
                                Opacity(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.only(top: 5) ,
                                      child: Text(
                                        movies.air.toString().replaceAll('T00:00:00.000Z', ''),
                                        style: TextStyle(
                                            fontSize: 13,
                                            fontWeight: FontWeight.bold,
                                            fontStyle: FontStyle.italic
